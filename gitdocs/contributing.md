...
Для индентации (отступ до текущего блока кода) всегда используем только пробелы согласно стандарту PEP8.

PEP8 рекомендует использовать 4 пробела для каждого уровня отступа. Это обеспечивает хороший баланс между читаемостью кода и экономией горизонтального пространства.
